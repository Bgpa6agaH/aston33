...
class NumberComparisonTest {
    ...
    public void testCompareNumbers_minValue_minValue() {
        ...
        assertEquals(expectedOutput, actualOutput, "Тест 4: Ошибка при MIN_VALUE = MIN_VALUE");
    }
    ...
    public void testCompareNumbers_maxValue_maxValue() {
        ...
        assertEquals(expectedOutput, actualOutput, "Тест 5: Ошибка при MAX_VALUE = MAX_VALUE");
    }
    ...
    public void testCompareNumbers_minValue_maxValue() {
        ...
        assertEquals(expectedOutput, actualOutput, "Тест 6: Ошибка при MIN_VALUE < MAX_VALUE");
    }
    ...
    public void testCompareNumbers_maxValue_minValue() {
        ...
        assertEquals(expectedOutput, actualOutput, "Тест 7: Ошибка при MAX_VALUE > MIN_VALUE");
    }
}
